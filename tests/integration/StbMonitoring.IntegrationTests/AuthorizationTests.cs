...
public sealed class AuthorizationTests
{
 ...
 [Fact]public void Ai_system_risk_is_restricted_to_operational_decision_roles(){var attribute=typeof(AiPredictionsController).GetCustomAttributes(typeof(AuthorizeAttribute),true).Cast<AuthorizeAttribute>().Single();Assert.Contains(RoleNames.Supervisor,attribute.Roles);Assert.Contains(RoleNames.ManagerIt,attribute.Roles);Assert.DoesNotContain(RoleNames.Technician,attribute.Roles);}
}
