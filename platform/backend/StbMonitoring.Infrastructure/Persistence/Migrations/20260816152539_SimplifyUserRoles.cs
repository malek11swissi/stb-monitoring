    ...
    public partial class SimplifyUserRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                UPDATE users AS u
                SET "Role" = COALESCE((
                    SELECT CASE WHEN r."Name" IN ('ADMIN','SUPERVISOR','TECHNICIAN','MANAGER_IT')
                                THEN r."Name" ELSE 'TECHNICIAN' END
                    FROM user_roles ur
                    INNER JOIN roles r ON r."Id" = ur."RoleId"
                    WHERE ur."UserId" = u."Id"
                    ORDER BY CASE r."Name" WHEN 'ADMIN' THEN 1 WHEN 'MANAGER_IT' THEN 2
