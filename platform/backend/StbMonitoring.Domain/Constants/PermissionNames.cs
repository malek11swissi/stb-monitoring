...
public static class PermissionNames
{
    ...
    public const string IncidentsRead="incidents.read"; public const string IncidentsManage="incidents.manage"; public const string IncidentsAssign="incidents.assign"; public const string IncidentsWork="incidents.work"; public const string IncidentsResolve="incidents.resolve"; public const string IncidentsClose="incidents.close";
    public const string SlaManage="sla.manage"; public const string NotificationsRead="notifications.read";
    public const string ReportingRead="reporting.read"; public const string ReportingExport="reporting.export";
    public static readonly string[] All = [UsersRead, UsersManage, AuditRead, SystemsRead, SystemsManage, ChecksRead, ChecksExecute,AlertsRead,AlertsAcknowledge,AlertRulesManage,IncidentsRead,IncidentsManage,IncidentsAssign,IncidentsWork,IncidentsResolve,IncidentsClose,SlaManage,NotificationsRead,ReportingRead,ReportingExport];

    public static IReadOnlyCollection<string> RolesFor(string permission) => permission switch
    {
        UsersRead or UsersManage or AuditRead or AlertRulesManage or SlaManage => [RoleNames.Admin],
        SystemsManage or ChecksExecute or AlertsAcknowledge or IncidentsManage or IncidentsAssign or IncidentsClose => [RoleNames.Admin, RoleNames.Supervisor],
        IncidentsWork or IncidentsResolve => [RoleNames.Admin, RoleNames.Supervisor, RoleNames.Technician],
        SystemsRead or ChecksRead or IncidentsRead or NotificationsRead or ReportingRead or ReportingExport => RoleNames.All,
